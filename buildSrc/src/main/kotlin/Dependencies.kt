...
object ComposeDeps {
    ...
    val composeMaterial3WindowSize by lazy {
        "androidx.compose.material3:material3-window-size-class:${Versions.composeMaterial3WindowSizeClass}"
    }
    val composeTVMaterial3 by lazy { "androidx.tv:tv-material:${Versions.materialTV}" }

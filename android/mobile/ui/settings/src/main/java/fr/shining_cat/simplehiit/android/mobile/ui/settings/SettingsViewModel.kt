...
import fr.shining_cat.simplehiit.domain.settings.CreateUserUseCase
import fr.shining_cat.simplehiit.domain.settings.DeleteUserUseCase
import fr.shining_cat.simplehiit.domain.settings.GetGeneralSettingsUseCase
import fr.shining_cat.simplehiit.domain.settings.ResetAllSettingsUseCase
import fr.shining_cat.simplehiit.domain.settings.SaveSelectedExerciseTypesUseCase
import fr.shining_cat.simplehiit.domain.settings.SetBeepSoundUseCase
import fr.shining_cat.simplehiit.domain.settings.SetNumberOfWorkPeriodsUseCase
import fr.shining_cat.simplehiit.domain.settings.SetPeriodStartCountDownUseCase
import fr.shining_cat.simplehiit.domain.settings.SetRestPeriodLengthUseCase
import fr.shining_cat.simplehiit.domain.settings.SetSessionStartCountDownUseCase
import fr.shining_cat.simplehiit.domain.settings.SetWorkPeriodLengthUseCase
import fr.shining_cat.simplehiit.domain.settings.ToggleExerciseTypeInListUseCase
import fr.shining_cat.simplehiit.domain.settings.UpdateUserNameUseCase
import fr.shining_cat.simplehiit.domain.settings.ValidateInputPeriodStartCountdownUseCase
import fr.shining_cat.simplehiit.domain.settings.ValidateInputSessionStartCountdownUseCase
import fr.shining_cat.simplehiit.domain.settings.ValidateInputUserNameUseCase
import fr.shining_cat.simplehiit.domain.settings.ValidateNumberOfWorkPeriodsUseCase
import fr.shining_cat.simplehiit.domain.settings.ValidatePeriodLengthUseCase

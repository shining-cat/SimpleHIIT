...
fun HomeTopBarComponent(
    ...
    TopAppBar(
        ...
        windowInsets = WindowInsets.systemBars.only(WindowInsetsSides.Top + WindowInsetsSides.Horizontal), // Changed this line
    )
}
...
private fun HomeTopBarComponentPreview() {
    SimpleHiitMobileTheme {
        Surface {
            Column(verticalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen.spacing_35))) {
                HomeTopBarComponent(
                    screenViewState =

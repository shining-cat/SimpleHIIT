...
internal class GetGeneralSettingsUseCaseTest : AbstractMockkTest() {
    ...
    private val testedUseCase = fr.shining_cat.simplehiit.domain.settings.GetGeneralSettingsUseCase(
    ...
    fun `calls repo and return success with correct order of values`() = runTest(UnconfinedTestDispatcher()) {
        ...
        //
        val generalSettingsFlowAsList = mutableListOf<fr.shining_cat.simplehiit.domain.common.Output<GeneralSettings>>()

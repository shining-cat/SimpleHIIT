 ...
 *
 * This module exists alongside the Koin localDataModule to support existing consumers
 * that still use Hilt. Once all consuming modules are migrated to Koin, this file
 * will be removed.
 *
 * DO NOT ADD NEW DEPENDENCIES HERE - use the Koin localDataModule instead.
 */
@Module
@InstallIn(SingletonComponent::class)
class LocalDataModuleHilt {
    @Provides

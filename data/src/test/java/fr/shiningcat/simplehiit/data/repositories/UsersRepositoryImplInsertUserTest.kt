...
internal class UsersRepositoryImplInsertUserTest : AbstractMockkTest() {
...
//   INSERT USER
    ...
    fun `insert user returns success when dao insert succeeds`() =
        runTest {
            ...
            //
            val actual = usersRepository.insertUser(testUserModel)
            //
        ...
        runTest {
            ...
            launch(job) {
                assertThrows<CancellationException> {
                    usersRepository.insertUser(testUserModel)
                }
            }
            delay(50L)

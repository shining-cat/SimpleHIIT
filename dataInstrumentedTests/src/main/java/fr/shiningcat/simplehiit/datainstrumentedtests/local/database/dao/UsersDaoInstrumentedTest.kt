...
// //////////////
    ...
    @Test
    fun testInsertUserWithConflict() =
        runTest {
...
// //////////////
    ...
    @Test
    fun getSelectedUsersEmptyTable() =
        runTest {
    ...
    @Test
    fun getSelectedUsersOnlyOneAndIsSelected() =
        runTest {
            val testUserName = "test user name"
            val testSelected = true
            val user = UserEntity(name = testUserName, selected = testSelected)
    ...
    @Test
    fun getSelectedUsersOnlyOneAndIsNotSelected() =
        runTest {
            val testUserName = "test user name"
    ...
    @Test
    fun getSelectedUsersAsTheyAreInserted() =
        runTest {
            val testUserName1 = "test user name 1"
            val testSelected1 = true
            val user1 = UserEntity(name = testUserName1, selected = testSelected1)
            ...
            assertEquals(
                2,
                users2.size,
            ) // we have now inserted a total of 3 users, but one is not selected
            assertEquals(testUserName1, users2[0].name)
            assertEquals(testSelected1, users2[0].selected)
...
// //////////////
    ...
    @Test
    fun updateUserNotPresent() =
        runTest {
            val userId = 1234L
            val updatedName = "updated user name"
            val updatedSelected = false
            val updatedUser =
                UserEntity(userId = userId, name = updatedName, selected = updatedSelected)
            var updated: Int = -1
    ...
    @Test
    fun updateOneUserDoesNotAffectRestOfTable() =
        runTest {
            val testUserName1 = "test user name 1"
            val testSelected1 = true
            val user1 = UserEntity(name = testUserName1, selected = testSelected1)
            ...
            val userUpdated =
                tableContentBefore[2].copy(name = userNameUpdated, selected = userSelectedUpdated)
            var updated = -1
...
// //////////////
    ...
    @Test
    fun deleteOneUserDoesNotAffectRestOfTable() =
        runTest {
            val testUserName1 = "test user name 1"
            val testSelected1 = true
            val user1 = UserEntity(name = testUserName1, selected = testSelected1)
...
// //////////////
    ...
    @Test
    fun deleteAllUsersOnlyOneInTable() =
        runTest {
            val testUserName = "test user name"
            val testSelected = true
            val user = UserEntity(name = testUserName, selected = testSelected)
    ...
    @Test
    fun deleteAllUsersEmptiesTable() =
        runTest {
            val testUserName1 = "test user name 1"
            val testSelected1 = true
            val user1 = UserEntity(name = testUserName1, selected = testSelected1)

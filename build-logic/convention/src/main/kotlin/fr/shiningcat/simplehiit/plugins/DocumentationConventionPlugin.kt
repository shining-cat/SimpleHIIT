...
class DocumentationConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            ...
            tasks.register("generateUnifiedDependencyGraph") {
                group = "documentation"
                ...
                doLast {
                    ...
                    val mobileGraph = file("build/reports/mobile-graph").readLines()
                    val tvGraph = file("build/reports/tv-graph").readLines()
                    ...
                    file("build/reports/dependency-graph.gv").writeText(combinedGraph)

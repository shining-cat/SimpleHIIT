...
internal class ValidateInputPeriodStartCountdownUseCaseTest : AbstractMockkTest() {
    ...
    private companion object {
        ...
        fun numberCyclesTestArguments() =
            Stream.of(
                Arguments.of("three", 20L, 10L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.WRONG_FORMAT),
                Arguments.of("3", 20L, 10L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE),
                Arguments.of("15", 20L, 10L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.VALUE_TOO_BIG),
                Arguments.of("25", 20L, 10L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.VALUE_TOO_BIG),
            )
    }
}
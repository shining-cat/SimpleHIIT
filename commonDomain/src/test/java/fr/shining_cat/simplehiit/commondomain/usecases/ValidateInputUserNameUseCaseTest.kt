        ...
        fun numberCyclesTestArguments() =
            Stream.of(
                Arguments.of(
                    ...
                    fr.shining_cat.simplehiit.commondomain.Constants.InputError.VALUE_ALREADY_TAKEN
                ),
                Arguments.of(
                    ...
                    fr.shining_cat.simplehiit.commondomain.Constants.InputError.TOO_LONG
                ),
                Arguments.of(
                    User(id=123L, name = "user test 1"),
                    listOf(
                    ...
                    fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE), //picking the same name for the same user id
                Arguments.of(
                    ...
                    fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE)
            )
    }
}
...
internal class ValidateInputSessionStartCountdownUseCaseTest : AbstractMockkTest() {
    ...
    fun `finding average number of sessions per 7-days period`(
        ...
        val testedUseCase = ValidateInputSessionStartCountdownUseCase(hiitLogger = mockHiitLogger)
    ...
    private companion object {
        ...
        fun numberCyclesTestArguments() =
            Stream.of(
                ...
                Arguments.of("369", fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE),
                Arguments.of("369346", fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE),

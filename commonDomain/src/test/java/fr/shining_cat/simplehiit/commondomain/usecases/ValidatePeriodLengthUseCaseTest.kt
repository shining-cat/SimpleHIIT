...
internal class ValidatePeriodLengthUseCaseTest : AbstractMockkTest() {
    ...
    private companion object {
        ...
        fun numberCyclesTestArguments() =
            Stream.of(
                Arguments.of("three", 123L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.WRONG_FORMAT),
                Arguments.of("10", 5L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE),
                Arguments.of("5", 5L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.NONE),
                Arguments.of("4", 5L, fr.shining_cat.simplehiit.commondomain.Constants.InputError.VALUE_TOO_SMALL),
            )
    }
}